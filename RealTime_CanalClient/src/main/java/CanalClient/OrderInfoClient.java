...
public class OrderInfoClient {
    public static void main(String[] args) throws InterruptedException, InvalidProtocolBufferException {
          /**
                ...
                (4)String password:  参考 instance.properties中的canal.passwd
                                  当前版本没有，使用null
         */
        CanalConnector canalConnector = CanalConnectors.newSingleConnector(new InetSocketAddress("hadoop102",11111), "example", null, null);
    ...
    private static void parseData(ByteString storeValue) throws InvalidProtocolBufferException {
        ...
        //只要insert类型 EventType:sql最具体的类型操作的关键字
        if(rowChange.getEventType()==CanalEntry.EventType.INSERT){
            ...
            System.out.println("成功写入"+rowDatasList.size()+"行数据...");
        }
    }
}